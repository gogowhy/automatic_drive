...
class sjtu_detection:  
	...
	self.pub_red = rospy.Publisher('has_red_light',Bool,queue_size=1)
	self.pub_green = rospy.Publisher('has_green_light',Bool,queue_size=1)
        #print 'Image is OK'  
	...
	if 'redlight' in result['detection_classes']:
